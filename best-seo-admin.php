...
<h2>Best SEO Custom Settings</h2>
...
<td><label><input name="seo_settings[theme_img]" type="checkbox" value="1" <?php checked('1', isset($options['theme_img'])); ?> />&nbsp;My active theme places an image(s) with alt text tagged with my post keywords.</label><div class="moz-info">If your theme automatically displays images that contain alt text matching the keywords for your site or pages, check this box and Best SEO will automatically credit each of your posts for it. If not, Best SEO recommends that you place an image into each of your posts that contains alt text with your primary keyword phrase.</div></td>
</tr>
<tr>
<th scope="row">Nofollow external links?</th>
<td><label><input name="seo_settings[nofollow]" type="checkbox" value="1" <?php checked('1', isset($options['nofollow'])); ?> />&nbsp;Enable nofollow filter on external content links</label><div class="moz-info">Check this box to have Best SEO add <b>rel="nofollow"</b> to all external links it finds in your post content. The filter runs each time you click "Update" while editing a post. <i><b>Tip</b>: Its good practice to have at least some externl links to external "trusted" sites. Use your blogroll link list for this as Best SEO does not alter these links. Remember to remove the default links first!</div></td>
</tr>
...
<div class="moz-info">Best SEO suggests and defaults to a keyword density range of between 1 to 4 percent. To customize this range, input your desired post/page content ranges for keyword density here and Best SEO will help you stay within your acceptable target range and score your posts accordingly.</div></td>
</tr>
...
-->
<tr>
<td colspan="2"><span class="moz-ok">Best SEO Version <strong>1.0</strong></span> <?php if (PHP_VERSION < 5) { ?><span class="moz-alert"><strong>IMPORTANT:</strong> Your site's speed and performance will increase dramatically when you ask your server host to upgrade your site to PHP Version 5.0 or greater. You are currently running <strong>PHP Version: <?php echo PHP_VERSION; ?></strong></span><?php } else { echo '<span class="moz-ok">PHP Version: <strong>'.PHP_VERSION; echo '</strong></span>'; } ?>
<?php global $wp_version; if($wp_version > 2.7 ) echo '<span class="moz-ok">WordPress: <b>'.$wp_version.'</b>'; else echo '<span class="moz-alert">Wordpress: <b>'.$wp_version. '</b> (Best SEO Suggests Version 2.8.2 or Better)'; ?>
</td>
</tr>
